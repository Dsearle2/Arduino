...
namespace Uduino
{
    ...
    public class BoardsTypeList
    {
        ...
        BoardsTypeList()
        {
            ...
            ArduinoBoardType defaultNanoBoard = new ArduinoBoardType("Default Nano", new int[] { 0, 13 }, new int[] { 14, 21 }, null);
            ...
            boardTypes.Add(new ArduinoBoardType("Arduino Nano", defaultNanoBoard.pins));
